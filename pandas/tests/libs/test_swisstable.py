...
Tests and iteration operations
"""
...
class TestValueCount:
    ...
    def test_int64_basic(self):
        ...
        keys, counts, _ = swisstable.value_count_int64(values)
    ...
    def test_float64_with_nan_dropna_true(self):
        ...
        keys, counts, _ = swisstable.value_count_float64(values, dropna=True)
    ...
    def test_float64_with_nan_dropna_false(self):
        ...
        values = np.array([1.0, np.nan, 1.0, np.nan, 2.0], dtype=np.float64)
        keys, counts, _ = swisstable.value_count_float64(values, dropna=False)
