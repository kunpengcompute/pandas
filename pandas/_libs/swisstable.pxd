...
cdef extern from "swisstable/swisstable_class.hpp" namespace "pandas::swisstable" nogil:
    ...
    cdef cppclass SwissTable[K, V]:
        ...
        c_ssize_t factorize_ingore_nan_batch "factorize_nan_batch<true>"(
            const K *keys,
            size_t n,
            K *uniques_out,
            c_ssize_t *labels_out,
            c_ssize_t na_sentinel,
            K nan_key
        )

        c_ssize_t factorize_batch "factorize_nan_batch<false>"(
            const K *keys,
            size_t n,
            K *uniques_out,
            c_ssize_t *labels_out,
